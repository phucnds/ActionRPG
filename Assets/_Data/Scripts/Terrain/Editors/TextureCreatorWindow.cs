...
public class TextureCreatorWindow : EditorWindow
{
    ...
    [MenuItem("PhucND/Terrain/TextureCreatorWindow")]
    public static void ShowWindow()
    {
        EditorWindow.GetWindow<TextureCreatorWindow>();
    }
    ...
    private void OnGUI()
    {
        ...
        int wSize = (int)(EditorGUIUtility.currentViewWidth - 32);
        ...
        brightness = EditorGUILayout.Slider("Brihtness", brightness, 0, 2);
