...
{
    [CreateAssetMenu(fileName = "Ability", menuName = "AdventureKingdom/Abilities/Ability", order = 0)]
    public class Ability : ActionItem
    {
        [SerializeField] TargetingStrategy targetingStrategy = null;
        [SerializeField] FilterStrategy[] filterStrategies = null;
        [SerializeField] EffectStrategy[] effectStrageties = null;
        ...
        private void TargetAquired(AbilityData data)
        {
            ...
            foreach (var effect in effectStrageties)
            {
