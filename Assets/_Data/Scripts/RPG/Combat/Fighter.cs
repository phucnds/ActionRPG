...
namespace RPG.Combat
{
    public class Fighter : MonoBehaviour, IAction
    {
        ...
        [SerializeField] float autoAttackRange = 10f;
        ...
        private Health FindNewTargetInRange()
        {
            ...
            foreach (var candidate in FindNewTargetsInRange())
            {
        ...
        private IEnumerable<Health> FindNewTargetsInRange()
        {
            ...
            foreach (var hit in raycastHits)
            {
                ...
                if (health.gameObject.tag == "Shop") continue;
                yield return health;
            }
        }
