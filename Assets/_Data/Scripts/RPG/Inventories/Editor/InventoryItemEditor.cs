...
namespace RPG.Inventories.Editor
{
    public class InventoryItemEditor : EditorWindow
    {
        ...
        /// </summary>
        [MenuItem("PhucND/RPG/InventoryItem Editor")]
        ...
        void OnEnable()
        {
            ...
            previewStyle.normal.background = EditorGUIUtility.Load("Assets/GUI PRO Kit - Fantasy RPG/ResourcesData/Sprites/Component/Frame/frame_stageframe_04_n.png") as Texture2D;
